...
ActiveRecord::Schema[7.2].define(version: 2025_09_01_093147) do
  ...
  create_table "catalog_product_subscriptions", force: :cascade do |t|
    t.string "type"
    t.text "description"
    t.string "slug"
    t.float "cost"
    ...
    t.index ["product_id"], name: "index_catalog_product_subscriptions_on_product_id"
    t.index ["user_id"], name: "index_catalog_product_subscriptions_on_user_id"
  end
